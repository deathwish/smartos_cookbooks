...
dns:: Set up DNS using node attributes.

hostname:: Set the hostname to the Chef node name, store in /etc/hostname.
...
var:: Enable atime on /var so logging works correctly.
